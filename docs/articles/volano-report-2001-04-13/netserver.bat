...
rem \jdk1.3.0_02\bin\java -server -showversion -Xms8m -Xmx256m -Xss32k COM.volano.Main
rem "\Program Files\IBM\Java13\bin\java" -showversion -Xms8m -Xmx256m -Xss32k COM.volano.Main
rem \jdk1.3.0_02\bin\java -jrockit -showversion -Xms8m -Xmx256m -Xss32k COM.volano.Main

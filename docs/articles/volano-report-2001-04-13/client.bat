...
for /L %%i in (1,1,4) do (
  ...
  rem \jdk1.3.0_02\bin\java -server -showversion -Xms8m -Xmx64m COM.volano.Mark -count 100
  rem "\Program Files\IBM\Java13\bin\java" -showversion -Xms8m -Xmx64m COM.volano.Mark -count 100
  rem \jdk1.3.0_02\bin\java -jrockit -showversion -Xms8m -Xmx64m COM.volano.Mark -count 100
